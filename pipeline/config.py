...
from pipeline.types import InjectionLayer, MutationKind, ProgramFamily, Protocol, Seed
...
class Config:
  ...
  mutation_kind: MutationKind = "inject"
  instance_id: int = 0
  combo: str = "baseline"
...
class NeedsInjector(View):
  ...
  @property
  def mutation_kind(self) -> MutationKind: ...
  @property
